...
![App Screenshot](<img width="969" height="2112" alt="image" src="https://github.com/user-attachments/assets/d469df61-a208-4d40-86e2-c4e85c3c0fe3" />
)
...
```bash
git clone [https://github.com/debjit003/expense-tracker-ocr.git](https://github.com/debjit003/expense-tracker-ocr.git)
